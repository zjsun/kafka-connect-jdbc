...
public class JdbcSourceConnectorConfig extends AbstractConfig {
    ...
    public static final String OFFSET_INITIAL_CONFIG = "offset.initial";
    public static final String OFFSET_EXTRACT_CONFIG = "offset.extract";
    public static final String SCRIPT_INIT_CONFIG = "init.script";
    public static final String SCRIPT_PRE_CONFIG = "pre.script";
    public static final String SCRIPT_POST_CONFIG = "post.script";
    ...
    public static ConfigDef baseConfigDef() {
        ...
        addDatavConfig(config);
        return config;
    }

    private static final void addDatavConfig(ConfigDef config) {
        ConfigUtils.configDkeMode(config);
        config.define(TIMESTAMP_FORMAT_CONFIG, Type.STRING, null, Importance.LOW, "-")
                .define(SCRIPT_INIT_CONFIG, Type.STRING, null, Importance.LOW, "-")
                .define(SCRIPT_PRE_CONFIG, Type.STRING, null, Importance.LOW, "-")
                .define(SCRIPT_POST_CONFIG, Type.STRING, null, Importance.LOW, "-")
                .define(OFFSET_INITIAL_CONFIG, Type.STRING, null, Importance.LOW, "-")
                .define(OFFSET_EXTRACT_CONFIG, Type.STRING, null, Importance.LOW, "-")
        ;
    }
    ...
    public Map<String, ?> getOffsetInitial() {
        return ConfigUtils.breakDownMap(getString(OFFSET_INITIAL_CONFIG));
    }

    public Map<String, ?> getOffsetExtract(){
        return ConfigUtils.breakDownMap(getString(OFFSET_EXTRACT_CONFIG));
    }

    public String getInitScript() {
        return getString(SCRIPT_INIT_CONFIG);
    }

    public String getPreScript() {
        return getString(SCRIPT_PRE_CONFIG);
    }

    public String getPostScript() {
        return getString(SCRIPT_POST_CONFIG);
    }
